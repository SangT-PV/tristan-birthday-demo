...
export const faqPairs: FAQPair[] = [
  ...
  },
  {
    ...
    answer: "\"AI multiplies good engineering. It does not replace it.\" That phrase captures how he approaches everything — disciplined, pragmatic, and grounded in real engineering craft. He showed the team that AI done properly amplifies a good engineer's judgement, rather than shortcutting around it.",
    keywords: ["motto", "quote", "philosophy", "ai", "engineering"]
  },
  {
    question: "What is Project Phoenix?",
    answer: "Project Phoenix is Panviva's Kubernetes and AKS containerisation journey, which Tristan drove end-to-end. Helm orchestration, secrets management, environment parity from Dev to Prod — not just 'working', but operationally sane. It's the foundation that makes modern Panviva deployments safe and repeatable.",
    keywords: ["phoenix", "project", "aks", "kubernetes", "containerisation"]
  },
  {
    question: "What makes Tristan remarkable?",
    answer: "Six things stand out: systems thinking across content, identity and infrastructure; being one of the first at Upland to wield AI as a real engineering tool; championing security evolution; a self-made path from chef to principal; low-ceremony mentorship that grew engineers internally; and the courage to make huge life moves (Melbourne → Townsville → Canada) while sustaining technical excellence.",
    keywords: ["remarkable", "qualities", "attributes", "makes", "special"]
  },
  {
    question: "Did Tristan really start as a chef?",
    answer: "Yes — truly. Before tech, Tristan worked in kitchens. No CS degree, no bootcamp, no traditional path. Just curiosity and appetite for hard problems. He entered Panviva through support in 2017, learned production systems the hard way, and grew into a principal engineer role through pure persistence and self-driven learning.",
    keywords: ["chef", "really", "kitchen", "background", "before"]
  },
  {
    question: "When did Tristan join Panviva?",
    answer: "August 2017 — through the support team. He spent his early years at Panviva living with real production issues and customer pain before writing a line of product code. That support-first grounding is a big reason he still builds systems that respect operational reality.",
    keywords: ["when", "join", "joined", "panviva", "2017", "support"]
  },
  {
    question: "Tell me about Core Modernisation",
    answer: "Panviva Core Modernisation is the project where Tristan quietly made the breakthrough architectural decisions — decoupling document type from layout, enforcing forward-only design, and preventing dangerous dual-truth systems. Those calls turned a scary legacy rewrite into a safe, controlled transformation. Without them, modernised Panviva simply wouldn't exist the way it does today.",
  ...
  },
  {
    ...
    answer: "Because it wasn't theoretical. On March 12 2026, Tristan showed AI applied with discipline to one of Panviva's most complex systems — real architecture, real data risk, real results. It flipped the team from 'interesting idea' to 'let's build'. Fourteen AI initiatives at Upland trace directly back to that moment.",
